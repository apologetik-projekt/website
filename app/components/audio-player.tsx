      ...
      <div className="rounded-px bg-black text-gray-100 dark:bg-black dark dark:text-white text-sm overflow-hidden p-2 box-border flex flex-col">
				...
				<div className="w-full flex items-center gap-1.5">
					<button
						...
						className="bg-gray-600/70 hover:brightness-110 transition-all duration-200 active:opacity-90 rounded-px p-2 leading-6 appearance-none">
						{ isLoading ? Spinner : isPlaying ? PauseIcon : PlayIcon }
					</button>
					<button aria-label="15 Sekunden zurückspulen" id="rewind" onClick={rewind} className="bg-gray-600/70 hover:brightness-110 transition-all duration-200 active:opacity-90 rounded-px p-2 leading-6 appearance-none">
					...
					<button aria-hidden className="md:hidden opacity-80 p-2 items-center" onClick={() => alert("Transparenzhinweis: Audioaufnahme wurde künstlich generiert.")}>
