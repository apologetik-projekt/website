				...
				<AnimatePresence custom={menuState.value == 'transition'}>
					{menuState.value === 'open' && <>
						...
						<motion.div exit={{ opacity: 0, transition: {duration: 0.2} }} initial={{ opacity: 0, y: 3 }} animate={{ opacity: 1, y: 0, transition: { ease: "easeInOut", delay: 0.58, duration: 0.4 } }}>
							<a className="ml-6 mt-42 leading-tight bg-gray-500 bg-opacity-20 hover:bg-opacity-40 rounded px-5 py-3 font-mono font-medium text-gray-300 text-sm inline-flex items-center" href="https://instagram.com/pologetikprojekt/" target="_blank">
