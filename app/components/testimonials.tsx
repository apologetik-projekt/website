					...
					<motion.div 
						...
						className="bg-white bg-opacity-90 text-lg p-4 px-3 md:px-4 w-64 aspect-square">
							...
							<div className="mt-2 px-0.5" style={{opacity: (index == 0) ? 1 : 0.2}}>
								<h3 className="font-extrabold font-mono mb-1">{quote.name}</h3>
								<div className="font-medium leading-snug text-gray-800 text-opacity-80" dangerouslySetInnerHTML={{__html: quote.text}}></div>
							</div>
					</motion.div>
				))}
				</AnimatePresence>
